...
def build_prediction_map(pred_df: pd.DataFrame) -> folium.Map:
    """
    Render ML predictions as:
    - A heatmap layer for each mineral (confidence as weight)
    ...
    for mineral in minerals:
        ...
        # Heatmap
        heat_data = sub[["latitude","longitude", prob_col]].values.tolist()
        HeatMap(
            heat_data,
